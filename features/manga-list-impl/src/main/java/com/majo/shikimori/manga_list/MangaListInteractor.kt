...
interface MangaListInteractor {
    fun loadManga(page: Int, limit: Int): Flow<MangaListInternalAction>
}
...
class MangaListInteractorImpl @Inject constructor(
    ...
    override fun loadManga(page: Int, limit: Int): Flow<MangaListInternalAction> {
        return flow {
            if (page == INIT_PAGE) {
            ...
            val list = aangaListApi.getMangas(page, limit)
